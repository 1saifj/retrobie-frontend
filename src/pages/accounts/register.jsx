...
import GoogleLogoVector from '../../assets/images/logos/google.svg';
import FacebookLogoVector from '../../assets/images/logos/facebook.svg';
                            ...
                            {({isSubmitting}) => (
                                <Form style={{padding: '0 24px'}}>
                                    ...
                                    <Columns>
                                        ...
                                        <Column isSize={{desktop: '1/2'}}>
                                            <TextField placeholder={'eg. Daniel'}
                                                       label={"Last name"}
                                                       type={'text'}
                                                       name={"lastName"}
                                            />
                                    ...
                                    <Columns>
                                        ...
                                        <Column isSize={{desktop: '1/2'}}>
                                            <TextField placeholder={'eg. +254 728 566 986'}
                                                       label={"Phone number"}
                                                       type={'tel'}
                                                       name={"phoneNumber"}
                                                       help={"Optional"}
