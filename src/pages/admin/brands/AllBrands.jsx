...
function AllBrandsAdmin(props) {
    ...
    const {status, data: allBrands, error} = useQuery('all_brands', getAllBrands);
    ...
    return (
        <>
            <div style={{padding: 20, background: 'white', height: '100vh'}}>
                <BrandHeader>
                    <div>
                        <h4>Brands.</h4>
                    </div>
