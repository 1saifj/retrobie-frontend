...
function Landing({history}) {
  return (
    <Layout className="App" style={{maxWidth: '1684px'}}>
      <SEOHeader
      ...
      <Section style={{background: `url('${LightPattern}')`}} id="app-body">
        <Container>
          <Discover />
        </Container>
      </Section>
...
export const CloseButton = ({closeToast}) => <button className="delete" onClick={closeToast} />;
